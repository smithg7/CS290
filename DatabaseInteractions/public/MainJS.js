...
function PopulateTable(data)
{
    ...
    for (var row in data) {
        ...
        var rowHTML = "<td><input type='text' style='visibility:hidden;size=30;' id='Vname" + data[row].id + "' value='";
        ...
        rowHTML += "<td><input type='checkbox' style='visibility:hidden;' id='Vlbs" + data[row].id + "' checked=";
